...
public class ConnectIT {
     ...
     */
    final String URL = "https://localhost:8443/apn/swagger-ui.html#/";
    ...
    public void sslConnect() throws KeyStoreException, IOException, CertificateException,
        ...
        /* Nitesh: Required if client auth is required at the server side

        // * Path to your client-side SSL certificate in the PKCS12 format, as generated by OpenSSL.
        final String KEY_STORE_PATH = "C:\\Nitesh-SENA\\ANTrackerWeb\\APN\\doc\\SSL\\client\\client_pavel.p12";
